              ...
              setTimeout(function(){
                  if($('.context-menu .item span')[1].innerHTML.indexOf('Google') > 0)
                    $('.context-menu .item-group:contains("Google")')
                        .append('',"<div class=\"item-group\" onclick=\"window.open('https://steamdb.info/search/?a=app&q='+encodeURIComponent(window.getSelection().toString()))\"><div class=\"item\"><span>Search on SteamDB</span> </div></div></div ><div class=\"hint\">");
              },250);
